...
UserWidget.propTypes = {
  userId: PropTypes.string, // 'userId' prop is required and should be a string
  picturePath: PropTypes.string, // 'picturePath' prop is required and should be a string
};
